The following are the contents in this folder:

-------------------------------------------------------------------------------------------------
 
all_encoder_weights.pt = contains the weights of encoder for all the 300 training iterations
on the default yelp dataset.
