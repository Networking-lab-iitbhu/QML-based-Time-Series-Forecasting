...
#     base_path = "C:/Users/geeth/Downloads/quantum-ml-main/quantum-ml-main/QEncoder_SP500_prediction/evaluation_results"
...
#         for member in tqdm(range(1, args.n_members + 1)):
#             model.args.version = member
#             weights_file = os.path.join(base_path, f"weights/{args.dataset}_{args.model}_{args.loss}_{args.depth}_{args.sentence_len}_{args.num_latent}_{args.num_trash}_{args.pad_mode}_{member}_{args.anz_set}_weights")
#             model_output_file = os.path.join(predictions_path, f"{args.dataset}_{args.model}_{args.loss}_{args.depth}_{args.sentence_len}_{args.num_latent}_{args.num_trash}_{args.pad_mode}_{member}_{args.machine}_{args.data_eval_cat}_{args.anz_set}_data.npy")
#             label_output_file = os.path.join(predictions_path, f"{args.dataset}_{args.model}_{args.loss}_{args.depth}_{args.sentence_len}_{args.num_latent}_{args.num_trash}_{args.pad_mode}_{member}_{args.machine}_{args.data_eval_cat}_{args.anz_set}_labels.npy")
...
#             if args.aws == 'on':
#                 s3.upload_file(model_output_file, args.s3_bucket, os.path.basename(model_output_file))
#                 s3.upload_file(label_output_file, args.s3_bucket, os.path.basename(label_output_file))
    
#     elif args.mode == 'eval_part':
#         member = model.args.version
#         weights_file = os.path.join(base_path, f"weights/{args.dataset}_{args.model}_{args.loss}_{args.depth}_{args.sentence_len}_{args.num_latent}_{args.num_trash}_{args.pad_mode}_{member}_{args.anz_set}_weights")
#         model_output_file = os.path.join(predictions_path, f"{args.dataset}_{args.model}_{args.loss}_{args.depth}_{args.sentence_len}_{args.num_latent}_{args.num_trash}_{args.pad_mode}_{member}_{args.machine}_{args.data_eval_cat}_{args.anz_set}_part_data.npy")
#         label_output_file = os.path.join(predictions_path, f"{args.dataset}_{args.model}_{args.loss}_{args.depth}_{args.sentence_len}_{args.num_latent}_{args.num_trash}_{args.pad_mode}_{member}_{args.machine}_{args.data_eval_cat}_{args.anz_set}_part_labels.npy")
...
def evaluate(
    ...
    # ✅ Fixed base_path for Linux
    base_path = os.path.expanduser("~/quantum-ml-main/quantum-ml-main/QEncoder_SP500_prediction/evaluation_results")
    predictions_path = os.path.join(base_path, "predictions")
    os.makedirs(predictions_path, exist_ok=True)
