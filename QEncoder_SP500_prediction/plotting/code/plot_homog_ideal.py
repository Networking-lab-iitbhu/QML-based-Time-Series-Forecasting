...
plt.ylim([0, 100])
ax.set_xticks([r + .5 * barWidth for r in range(5)])
...
plt.legend(
    ...
    edgecolor="black",
    loc="upper right",
    bbox_to_anchor=(0.0089, 1.15, 1.0, 0.102),
    borderaxespad=0.2,
    fontsize=12,
    handletextpad=0.5,
)
...
# plt.show()
mp.savefig("plotting/plots/homog_ideal.pdf", pad_inches=0.01, bbox_inches="tight")
