...
from modules.encoder import train_encoder
# from evaluate_models import evaluate
# from evaluate_model_outputs import aggregate_outputs
from models import (
...
parser.add_argument("--sentence_len", dest="sentence_len", type=int, default=15)
...
parser.add_argument("--num_latent", dest="num_latent", type=int, default=2)
parser.add_argument("--num_trash", dest="num_trash", type=int, default=3)
...
pca_glove_test, labels_test = X[train_split: train_split + test_split], Y[train_split: train_split + test_split]
...
# elif args.mode =='eval' or args.mode =='eval_part':
#     evaluate(
#     sentiment_circuit,
#     pca_glove_train,
#     labels_train,
