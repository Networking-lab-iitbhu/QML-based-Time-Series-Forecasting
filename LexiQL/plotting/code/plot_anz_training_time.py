...
'Depth3_Circuit2': [
    ...
    'Depth2_F': [
    [893,836,1027,573,575],
],
    'Depth2_G': [
    [952,910,1102,596,594],
],
    'Depth3_C': [
    [1040,987,1108,525,524],
],
    'Depth3_F': [
    [1128,1196,1357,620,628],
],
    'Depth3_G': [
    [1303,1266,1448,648,673],
],
}
order = [2,1,0,4,3]
...
plt.ylabel("Training Time (Minutes)", size=14)
...
# plt.show()
mp.savefig(f"plotting/plots/train_d1.pdf", pad_inches=0.01, bbox_inches="tight")
mp.clf()
